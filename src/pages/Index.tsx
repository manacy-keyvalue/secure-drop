      ...
      <div className="flex items-center justify-center min-h-screen px-6">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="relative mb-12">
            <div className="w-32 h-32 mx-auto rounded-full gradient-primary flex items-center justify-center glow-primary animate-pulse-glow">
              <Shield className="w-16 h-16 text-primary-foreground" />
            </div>
            <div className="absolute inset-0 w-32 h-32 mx-auto rounded-full border-2 border-primary/30 animate-spin" style={{ animationDuration: '4s' }} />
          </div>
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
            Enterprise-grade secure file upload platform with AI-powered threat detection, 
            real-time scanning, and compliance-ready features for modern applications.
          </p>
      ...
      <div className="py-24 border-t border-border/30">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Built for modern applications that demand the highest security standards</p>
          </div>
            ...
            {features.map((feature, index) => (
              ...
              >
                ...
                <div className="relative z-10 text-center">
                  <div className={`w-16 h-16 mx-auto mb-6 rounded-full bg-gradient-to-br from-${feature.color.split('-')[1]}/20 to-${feature.color.split('-')[1]}/10 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
      ...
      <div className="py-24 bg-muted/20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">Advanced security features that keep your files safe</p>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            {benefits.map((benefit, index) => (
              <div key={index} className="flex items-start gap-4 p-4 rounded-lg hover:bg-primary/5 transition-colors duration-200">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-8 rounded-xl bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 hover:scale-105 transition-transform duration-200">
              ...
              <div className="text-muted-foreground font-medium">Threat Detection Rate</div>
            </div>
            <div className="text-center p-8 rounded-xl bg-gradient-to-br from-success/10 to-success/5 border border-success/20 hover:scale-105 transition-transform duration-200">
              <div className="text-5xl font-bold text-success mb-3">&lt;250ms</div>
              <div className="text-muted-foreground font-medium">Average Scan Time</div>
            </div>
            <div className="text-center p-8 rounded-xl bg-gradient-to-br from-accent/10 to-accent/5 border border-accent/20 hover:scale-105 transition-transform duration-200">
              ...
              <div className="text-muted-foreground font-medium">GDPR Compliant</div>
            </div>
            <div className="text-center p-8 rounded-xl bg-gradient-to-br from-warning/10 to-warning/5 border border-warning/20 hover:scale-105 transition-transform duration-200">
              ...
              <div className="text-muted-foreground font-medium">Security Monitoring</div>
            </div>
          </div>
        </div>
      </div>
